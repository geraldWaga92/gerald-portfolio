...
const Contact = () => {
  return (
    <div id="contact" className="w-full lg:h-screen">
      <div className="max-w-[1240px] m-auto px-2 py-40 w-full ">
        ...
        <div className="grid lg:grid-cols-5 gap-8">
          ...
          <div className="col-span-3 w-full h-auto shadow-xl shadow-gray-400 rounded-xl lg:p-4">
            <div className="p-4">
              <form
                action="https://getform.io/f/9a6a9871-cbfc-40b0-be94-5b4f5fc22748"
                method="POST"
              ...
              >
                ...
                <button className="w-full p-4 text-gray-100 mt-4 hover:text-pink-700">
                  Send Message
                </button>
              </form>
            </div>
